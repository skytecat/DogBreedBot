...
|--------------------------|-----------------------------------------|------------------------------------------------------------------------------------|
| Детекция объектов        | YOLOv8n (Ultralytics)                   | Лёгкая, быстрая и точная модель, отлично работающая на CPU; поддержка предобученных весов на COCO |
...
<table>
  <tr>
    <td><img src="assets/tricky_photos/detection/photo_0.jpg" style="width:330px; height:400px; object-fit:cover; object-position:center;" alt="Фото 1"></td>
    <td><img src="assets/tricky_photos/detection/photo_1.jpg" style="width:330px; height:400px; object-fit:cover; object-position:center;" alt="Фото 2"></td>
    <td><img src="assets/tricky_photos/detection/photo_2.jpg" style="width:330px; height:400px; object-fit:cover; object-position:center;" alt="Фото 3"></td>
  </tr>
</table>
